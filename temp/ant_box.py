...
class AntBoxEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def sample_tasks(self, num_tasks):
        ...
        if self.env_type == 'test':
            box_x_positions = np.linspace(-8, 8, num_tasks)
        else:
            box_x_positions = np.random.uniform(-8, 8, size=(num_tasks,))
    ...
    def reset_task(self, idx=0):
        ...
        self._init_box_x_position = 7.8#self._task['box_x_position']
        self._init_box_y_position = 8 #self._task['box_y_position']
